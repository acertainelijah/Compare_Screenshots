...
class Example():
    def __init__(self):
        ...
        imageFile = "base_google_screenshot.png"
        self.image1 = ImageTk.PhotoImage(Image.open(imageFile))
        self.image2 = ImageTk.PhotoImage(Image.open("youtube_screenshot.png"))
        ...
        self.root.after(30000, update_image(self))
        self.root.mainloop()
...
def update_image(self):
    if self.display == self.image1:
        ...
        print "Display image1"
        self.display = self.image1
    self.root.after(30000, update_image(self))       # Set to call again in 30 seconds
